...
const DashboardLayout = () => {
  ...
  const labNavigation = [
    ...
    // { name: 'Nutrição', href: '/dashboard/nutrition', icon: Apple, roles: ['LAB'] }, // Temporariamente desabilitado
  ];
  ...
  const navigation = [
    ...
    // { name: 'Nutrição', href: '/dashboard/nutrition', icon: Apple, roles: ['ADMIN', 'BRAND'] }, // Temporariamente desabilitado
                ...
                <div className="relative">
                  <div className="flex items-center space-x-3">
                    ...
                    >
                      ...
                      <span className="hidden md:block">{user?.name || user?.email || 'Usuário'}</span>
                    </Link>
