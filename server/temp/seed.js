...
function main() {
    return __awaiter(this, void 0, void 0, function () {
        var adminPassword, admin, lab1, lab2, brandPassword, brand, product1, product2, labPassword, labUser;
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 2:
                    ...
                    return [4 /*yield*/, prisma.laboratory.upsert({
                ...
                case 4:
                    ...
                    return [4 /*yield*/, bcryptjs_1.default.hash('brand123', 12)];
                case 5:
                    brandPassword = _a.sent();
                    return [4 /*yield*/, prisma.user.upsert({
                ...
                case 8:
                    ...
                    return [4 /*yield*/, bcryptjs_1.default.hash('lab123', 12)];
                case 9:
                    labPassword = _a.sent();
                    return [4 /*yield*/, prisma.user.upsert({
